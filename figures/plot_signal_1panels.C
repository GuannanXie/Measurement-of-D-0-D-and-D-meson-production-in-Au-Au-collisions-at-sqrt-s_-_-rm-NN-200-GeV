...
void plot_signal_1panels()
{
   ...
   for (int i = 0; i < 1; i++)
   {
      ...
      pad[i] = new TPad(Form("pad_%d", i), "", 0, 0, 1, 1);
   ...
   for (int i = 0 ; i < 1; i++)
   {
      ...
      hInvMassUL[i]->SetMaximum(1.9 * hInvMassUL[i]->GetMaximum());
      ...
      hInvMassUL[i]->GetXaxis()->SetLabelSize(0.05);
      ...
      hInvMassUL[i]->GetYaxis()->SetLabelSize(0.05);
      ...
      if (i == 0) drawLatex(0.22, 0.88, "STAR Au+Au #sqrt{s_{NN}} = 200 GeV", 42, 0.05, 1);
      ...
      // if (i == 1)
      {
         ...
         TLegend* legend2 = new TLegend(0.20, .65, .5, .78);
      ...
      {
         // TLegend* legend2 = new TLegend(0.18, .71, .5, .85);
         TLegend* legend2 = new TLegend(0.50, .65, .9, .78);
         legend2->SetTextFont(42);
         legend2->SetTextSize(0.042);
         legend2->SetBorderSize(0);
         legend2->SetFillStyle(0);
   ...
   c1->SaveAs("Fig/fig1_signal_1panel.pdf");
   c1->SaveAs("Fig/fig1_signal_1panel.png");
